...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    match ($action) {
        ...
        'annual-bag-limit-setting' => $controller->updateAnnualBagLimitSetting($_POST),
        'possible-duplicate-warning-setting' => $controller->updatePossibleDuplicateWarningSetting($_POST),
        ...
        'offline-device-enroll' => $controller->enrollOfflineDevice($_POST),
        'offline-device-revoke' => $controller->revokeOfflineDevice($_POST),
        'offline-device-validate' => $controller->validateOfflineDevice($_POST),
        'offline-submission-reserve' => $controller->reserveOfflineSubmission($_POST),
        'offline-submission-complete' => $controller->completeOfflineSubmission($_POST),
