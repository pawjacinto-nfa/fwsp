...
$requiredAttr = $locationRequired ? 'required' : '';
...
<div class="<?= e($locationClass) ?>">
    ...
    <select <?= $requiredAttr ?> name="<?= e($locationPrefix) ?>region_id" class="form-select" data-location-level="region" data-selected="<?= e($locationValues['region_id'] ?? '') ?>">
...
<div class="<?= e($locationClass) ?>">
    ...
    <select <?= $requiredAttr ?> name="<?= e($locationPrefix) ?>branch_id" class="form-select" data-location-level="branch" data-selected="<?= e($locationValues['branch_id'] ?? '') ?>">
        <option value=""><?= e($emptyLabel) ?></option>
...
<div class="<?= e($locationClass) ?>">
    ...
    <select <?= $requiredAttr ?> name="<?= e($locationPrefix) ?>province_id" class="form-select" data-location-level="province" data-selected="<?= e($locationValues['province_id'] ?? '') ?>">
        <option value=""><?= e($emptyLabel) ?></option>
...
<div class="<?= e($locationClass) ?>">
    ...
    <select <?= $requiredAttr ?> name="<?= e($locationPrefix) ?>warehouse_id" class="form-select" data-location-level="warehouse" data-selected="<?= e($locationValues['warehouse_id'] ?? '') ?>">
        <option value=""><?= e($emptyLabel) ?></option>
