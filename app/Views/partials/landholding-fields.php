...
<section class="farm-location-card" data-farm-location>
    ...
    <div class="row g-3">
        <div class="col-md-3"><label class="form-label">Palay Location</label><input name="farms[<?= e($farmIndex) ?>][palay_location]" value="<?= e($farm['palay_location'] ?? '') ?>" class="form-control"></div>
        ...
        <div class="col-md-2"><label class="form-label">Yield/ha (Main)</label><input type="number" step="0.001" name="farms[<?= e($farmIndex) ?>][main_crop_yield]" value="<?= e($farm['main_crop_yield'] ?? $farm['average_yield'] ?? '') ?>" class="form-control"></div>
        <div class="col-md-2"><label class="form-label">Yield/ha (Summer)</label><input type="number" step="0.001" name="farms[<?= e($farmIndex) ?>][summer_crop_yield]" value="<?= e($farm['summer_crop_yield'] ?? '') ?>" class="form-control"></div>
    </div>
