<section class="workspace-section installer-page">
    <header class="installer-hero">
        <div>
            <p class="eyebrow">Desktop application</p>
            <h1>FSR Application Installer</h1>
            <p>Install Farmer-Seller Registry as an application on your Windows computer. It opens directly to the official FSR sandbox—no browser address to type.</p>
        </div>
        <img src="assets/images/farmer-seller-registry-logo-optimized.webp" alt="Farmer-Seller Registry logo">
    </header>

    <div class="installer-download-card">
        <div>
    ...
    <section class="installer-steps" aria-labelledby="installationStepsTitle">
        <div class="section-head compact">
            <div><p class="eyebrow">Simple installation guide</p><h2 id="installationStepsTitle">Install it in four easy steps</h2></div>
        </div>
        <ol>
    ...
    <section class="installer-notes" aria-labelledby="beforeTitle">
        ...
        <p>Need help? <a href="index.php?page=tech-support">Open Tech Support</a>.</p>
    </section>
</section>
