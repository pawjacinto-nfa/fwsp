        ...
        <form method="post" enctype="multipart/form-data" class="panel form-panel farmer-profile-edit" data-farmer-profile-form>
            ...
            <fieldset disabled data-farmer-profile-fields>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4"><label class="form-label">Farmer Passbook / Valid ID</label><input type="file" name="farmer_valid_id" accept=".jpg,.jpeg,.png,image/jpeg,image/png" class="form-control"><small class="text-muted">One JPG or PNG only, max 50MB.</small><?php if (!empty($farmer['valid_id_path'])): ?> <a class="d-block small mt-1" href="<?= e($farmer['valid_id_path']) ?>" target="_blank" rel="noopener">View current upload</a><?php endif; ?></div>
                </div>
