<section class="workspace-section">
    ...
    <aside class="col-lg-4">
        <section class="panel notification-delete-panel">
            <p class="eyebrow text-danger">Storage maintenance</p>
            <h2 class="h5">Delete all notifications</h2>
            <p class="text-muted mb-3">Permanently remove every notification currently associated with your account.</p>
            <form method="post">
                <input type="hidden" name="action" value="notifications-delete-all">
                <button class="btn btn-outline-danger" type="submit" data-confirm-title="Delete All Notifications" data-confirm-message="Delete all of your notifications permanently? This cannot be undone." data-confirm-accept="Delete All">Delete all notifications</button>
            </form>
            <div class="notification-delete-tip" role="note"><strong>Tip</strong><span>Use this after reviewing old notifications to reduce unused notification records. New notifications will still appear normally.</span></div>
        </section>
        <section class="panel notification-settings"><h2 class="h5">Notification settings</h2><form method="post"><input type="hidden" name="action" value="notification-preferences">
